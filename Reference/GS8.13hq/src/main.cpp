...
vex::controller con;
    ...
    /*---------------------------------------------------------------------------*/
void aut_tgo(float S,float a,int time1)
{
    float getS = 0;
    float vmax = 200;
    float v = 0;
        ...
        while(getS < S -3 && Brain.timer(timeUnits::msec) < time1)
    {
        ...
        if((pot_b.value(rotationUnits::deg) >=25))       
      {
       TT.spin(directionType::fwd,200, velocityUnits::pct);
       Brain.Screen.setCursor(2, 1);
       Brain.Screen.print(pot_b.value(rotationUnits::deg));   
      }
      else   
      {
      TT.spin(directionType::fwd,0, velocityUnits::pct);
      }
        if( getS < 0)
        {
             getS = -1 * getS;
 ...
 while (1) 
  {
    ...
    if ((d==0)&&(f==1) &&((con.ButtonUp.pressing())||(bum_a.pressing())))
    {
       d=1;
       aut_tygo(300, 40,  1500);
       TT.resetRotation();
       while((pot_b.value(rotationUnits::deg) <=75))
       {
         TT.spin(directionType::rev, 60, velocityUnits::pct);
         Brain.Screen.setCursor(2, 1);
         Brain.Screen.print(pot_b.value(rotationUnits::deg));
       }
       TT.stop(brakeType::hold);
       task::sleep(300);
       aut_xxgo(-404, 50,  3000);
       task::sleep(100);
       XX.spin(directionType::fwd, 100, velocityUnits::pct);
       autoTurnLeft(193, 40, 1000);
       LF.spin(directionType::fwd, 60, velocityUnits::pct);
       LB.spin(directionType::fwd, 60, velocityUnits::pct);
       RF.spin(directionType::fwd, -60, velocityUnits::pct);
       RB.spin(directionType::fwd, -60, velocityUnits::pct);
       ...
       RF.stop(brakeType::hold);
       RB.stop(brakeType::hold);
         while((pot_b.value(rotationUnits::deg) >=68))
       {
         TT.spin(directionType::rev, -40, velocityUnits::pct);
         Brain.Screen.setCursor(2, 1);
         Brain.Screen.print(pot_b.value(rotationUnits::deg));
       }
       TT.stop(brakeType::hold);
       ...
       task::sleep(200);
       aut_punch();
       autoTurnLeft(10, 30, 500);
       aut_ygo(1000, 50, 2000);
       LF.stop(brakeType::hold);
       LB.stop(brakeType::hold);
       RF.stop(brakeType::hold);
       RB.stop(brakeType::hold);
      ...
      TT.stop(brakeType::coast);
       aut_ygo(-525, 40, 2000);
       autoTurnRight(195,30,2000);
       aut_tygo(1000, 30,  1500);
       LF.spin(directionType::fwd, 20,velocityUnits::pct);
       LB.spin(directionType::fwd, 20,velocityUnits::pct);
       RF.spin(directionType::fwd, 20,velocityUnits::pct);
       RB.spin(directionType::fwd, 20,velocityUnits::pct);
    ...
    RB.stop(brakeType::hold); 
       while((pot_b.value(rotationUnits::deg) <=75))
       {
         TT.spin(directionType::rev, 50, velocityUnits::pct);
         Brain.Screen.setCursor(2, 1);
         Brain.Screen.print(pot_b.value(rotationUnits::deg));
       }
        TT.stop(brakeType::hold);
        autoTurnLeft(127, 30, 3000);
        task::sleep(300);
        //autoDriveDegrees(450, 40, 1000);
         /* while((pot_b.value(rotationUnits::deg) >=25))       
      {
       TT.spin(directionType::fwd,200, velocityUnits::pct);
       Brain.Screen.setCursor(2, 1);
       Brain.Screen.print(pot_b.value(rotationUnits::deg));   
       ...
       TT.stop(brakeType::brake);
       autoDriveDegrees(-450, 40, 5000);*/
       aut_tygo(-450, 40, 5000);
       aut_punch();
       f=0;
     ...
     else if (con.ButtonY.pressing()) 
    {
     ...
     else if ((pot_h.value(rotationUnits::deg) >= 50) &&(!limit_g.pressing()) && (c == 1)&&(f==1)) 
    {
