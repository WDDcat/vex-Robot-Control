...
#include "C:/Program Files (x86)/VEX Robotics/VEXcode/sdk/vexv5/gcc/include/time.h"
 ...
 while (1) 
  {
    ...
    {  
       ...
       aut_punch();
       task::sleep(50);
       autoTurnLeft(220,30, 1000);
       aut_xxgo(-1100, 40,2500);
       aut__xx(500);
       autoTurnRight(295, 40, 1000);
       task::sleep(100);
       ...
       motor_20.stop(brakeType::coast);
       f=0;
       /*autoTurnRight(390,30,2000);
       aut_tygo(400, 40,  1500);
       LF.stop(brakeType::hold);
       LB.stop(brakeType::hold);
       RF.stop(brakeType::hold);
       RB.stop(brakeType::hold);
