 ...
 while (1) 
  {
    ...
    if ((d==0)&&((con.ButtonUp.pressing())||(bum_a.pressing())))
    {
      task::sleep(2000);
       ...
       task::sleep(1500);
       TT.resetRotation();
       autoDriveDegrees(120, 30,2000);
       autoTurnRight(210,30,3000);
         LF.spin(directionType::fwd, -60, velocityUnits::pct);
       LB.spin(directionType::fwd, -60, velocityUnits::pct);
       RF.spin(directionType::fwd, -60, velocityUnits::pct);
       RB.spin(directionType::fwd, -60, velocityUnits::pct);
       ...
       TT.stop(brakeType::hold);
       aut_ygo(-640, 30, 3000);
       autoTurnLeft(190, 30, 2000);
       //autoDriveDegrees(-210,30,2000);
       while(TT.rotation(rotationUnits::deg)>-790)
       {
       TT.spin(directionType::rev, 55, velocityUnits::pct);
       LF.spin(directionType::fwd, 0, velocityUnits::pct);
       LB.spin(directionType::fwd, 0, velocityUnits::pct);
      ...
      TT.spin(directionType::rev, 0, velocityUnits::pct);
     TT.stop(brakeType::coast);
     task::sleep(500);
      while(TT.rotation(rotationUnits::deg)<-500)
       {
       TT.spin(directionType::rev, -30, velocityUnits::pct);
       LF.spin(directionType::fwd, 40, velocityUnits::pct);
       LB.spin(directionType::fwd, 40, velocityUnits::pct);
       RF.spin(directionType::fwd, 40, velocityUnits::pct);
       RB.spin(directionType::fwd, 40, velocityUnits::pct);
       }
       LF.spin(directionType::fwd, 0, velocityUnits::pct);
       LB.spin(directionType::fwd, 0, velocityUnits::pct);
       RF.spin(directionType::fwd, 0, velocityUnits::pct);
       ...
       RB.spin(directionType::fwd, 0, velocityUnits::pct);
         ...
         TT.stop(brakeType::coast);
         autoTurnLeft(230, 30,3000);
         autoDriveDegrees(-200,30 ,2000 );
         autoTurnLeft(220, 30,3000);
         autoDriveDegrees(-800,40,2000);
       LF.spin(directionType::fwd, -0,velocityUnits::pct);
       LB.spin(directionType::fwd, -0,velocityUnits::pct);
       RF.spin(directionType::fwd, -0,velocityUnits::pct);
       RB.spin(directionType::fwd, -0,velocityUnits::pct);
